...
let missing = ["PORT", "DATABASE_URL", "GDRIVE_CLIENT_ID", "GDRIVE_CLIENT_SECRETE", "GDRIVE_REDIRECT_URI", "PCLOUD_CLIENT_ID", "PCLOUD_APP_SECRET", "PCLOUD_REDIRECT_URI"].filter(
